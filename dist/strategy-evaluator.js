...
function evaluateCreditSpread(strategy, maxCollateral) {
...
function evaluateIronCondor(strategy, maxCollateral) {
...
function getTriangleExpectedReturns(shortLeg, longLeg, maxGain, type) {
    //find the breakeven
